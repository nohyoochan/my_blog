!function(i) {
        ...
        return this.each(function() {
            ...
            function t(i) {
                ...
                if (n && n.length) {
                    var o = e - n[0].pageX
                      , r = a - n[0].pageY;
                    o >= 50 && s.trigger("swipeLeft"),
                    -50 >= o && s.trigger("swipeRight"),
                    r >= 50 && s.trigger("swipeUp"),
                    -50 >= r && s.trigger("swipeDown"),
    ...
    i.fn.HSlider = function(t) {
        ...
        i.fn.slideLeft = function() {
            var n = i(".Hslider_S.active").data("index");
            return o > n && (location.hash = "#" + (n + 1)),
            i(this)
        }
        ,
        i.fn.slideRight = function() {
            var n = i(".Hslider_S.active").data("index");
            return o >= n && n > 1 && (location.hash = "#" + (n - 1)),
            i(this)
        }
        ,
        i.fn._render = function() {
            ...
            n > o && (n = o);
            var t = n;
            i(".Hslider_S.active").removeClass("active"),
            i(".pagination li a.active").removeClass("active"),
            i(".Hslider_S[data-index=" + t + "]").addClass("active"),
            i(".pagination li a[data-index=" + t + "]").addClass("active");
            var s = 100 * (t - 1) * -1;
            return a.transformPage(e, s),
            i(this)
        }
        ,
        i.fn._renderPagination = function() {
            e.pagination && (i("<ul class='pagination'>" + l + "</ul>").prependTo("body"),
            posTop = a.find(".HSlider").height() / 2 * -1,
            a.find(".HSlider").css("margin-top", posTop),
            i(".pagination li a").click(function() {
        ...
        i.fn._bindEvent = function() {
            return i(window).on("hashchange", a._render),
            i(document).bind("mousewheel DOMMouseScroll", function(i) {
                i.preventDefault();
        ...
        i.fn._initStyle = function() {
            ...
            i.each(s, function(n) {
                i(this).css({
                    ...
                    height: "100%",
                    left: 100 * n + "%"
                }).addClass(".Hslider_S").attr("data-index", n + 1),
                i(this).find("img").css({
                    position: "absolute"
                }),
                i(this).find(".Hslider_A").css({
                    position: "absolute",
